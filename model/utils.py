...
import jax
import numpy as np
from model import wideresnet_noise_conditional
from flax.training import checkpoints
from utils.helpers import batch_mul
import optax
...
class State:
    step: int
    optimizer_state: optax.OptState  # Holds the optimizer state
    params: Any  # Holds the model parameters
    lr: float
    model_state: Any
    ema_rate: float
    params_ema: Any
